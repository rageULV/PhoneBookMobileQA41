...
public class ContactModel implements Serializable {
    ...
    public ContactModel(String name, String lastName, String phone, String email, String address, String description) {
        this.name = name;
        this.lastName = lastName;
        this.phone = phone;
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ContactModel contact)) return false;
    ...
    public  static void serializeContact(ContactModel contact, String fileName) throws IOException {

        ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream(fileName));

        outputStream.writeObject(contact);
    }
    public static ContactModel desiarializeContact(String fileName){
        try (
                ObjectInputStream inputStream = new ObjectInputStream(new FileInputStream(fileName));){
            return (ContactModel) inputStream.readObject();
